...
O monitor usa o SRV do domínio principal para descobrir apenas o host temporário `*.aternos.host`. A porta usada pelo bot é fixa em `13174`. Quando o servidor fica offline, `/ip` e os avisos automáticos continuam mostrando o último host temporário conhecido; o domínio principal `MineEmpiresOf.aternos.me` nunca é exibido.
